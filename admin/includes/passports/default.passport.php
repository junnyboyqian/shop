...
class DefaultPassportUser extends BasePassportUser
{
    ...
    /* QQ 登陆注册 */
    function registerQQLogin($user_name,$password,$local_data = array()) {
        /* if (!$this->check_username($user_name))
        {
            return false;
        }*/
	 ...
	 function registerSLogin($user_name,$password,$local_data = array()) {
        /* if (!$this->check_username($user_name))
        {
            return false;
        }*/
    ...
    /* 手机注册 */
    function registerMobile($user_name,$phone,$password,$local_data = array()) {
    ...
    function get($flag, $is_name = false)
    {
        ...
        $info = $this->_local_get($conditions);
        if (!$info['password']) {
            $conditions = "email='{$flag}'";
            $info = $this->_local_get($conditions);
        }
        return $info;
    }
    ...
    function check_phone($phone)
    {
        ...
        $model_member =& m('member');
        $info = $model_member->get("phone_mob='{$phone}'");
        if (!empty($info))
        {
