        ...
        <table class="infoTable">
            ...
            <tr>
                <th class="paddingT15">
                    根类图片:</th>
                <td class="paddingT15 wordSpacing5">
                    <input class="infoTableFile2" id="root_image" type="file" name="root_image" />
                    <label class="field_notice">支持格式gif,jpg,jpeg,png</label>
                </td>
            </tr>
            <?php if ($this->_var['gcategory']['root_image']): ?>
            <tr>
                <th class="paddingT15">
                </th>
                <td class="paddingT15 wordSpacing5">
                <img src="<?php echo $this->_var['gcategory']['root_image']; ?>" class="makesmall" max_width="120" max_height="90" />
                </td>
            </tr>
            <?php endif; ?>
            <tr>
                <th class="paddingT15">
                    子类图片:</th>
                <td class="paddingT15 wordSpacing5">
                    <input class="infoTableFile2" id="cate_image" type="file" name="cate_image" />
                    <label class="field_notice">支持格式gif,jpg,jpeg,png</label>
                </td>
            </tr>
            <?php if ($this->_var['gcategory']['cate_image']): ?>
            <tr>
                <th class="paddingT15">
                </th>
                <td class="paddingT15 wordSpacing5">
                <img src="<?php echo $this->_var['gcategory']['cate_image']; ?>" class="makesmall" max_width="120" max_height="90" />
                </td>
            </tr>
            <?php endif; ?>
            <tr>
                <th class="paddingT15">
                    子类广告图片:</th>
                <td class="paddingT15 wordSpacing5">
                    <input class="infoTableFile2" id="cate_adimg" type="file" name="cate_adimg" />
                    <label class="field_notice">支持格式gif,jpg,jpeg,png</label>
                </td>
            </tr>
            <?php if ($this->_var['gcategory']['ad_image']): ?>
            <tr>
                <th class="paddingT15">
                </th>
                <td class="paddingT15 wordSpacing5">
