...
<div class="info">
  <form method="post" enctype="multipart/form-data">
    <table class="infoTable">
      ...
      <tr>
        <th class="paddingT15"><label for="exchange_rate"> 当前汇率:</label></th>
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput" id="exchange_rate" type="text" name="exchange_rate" value="<?php echo $this->_var['setting']['exchange_rate']; ?>"/></td>
      </tr>
<!--      <tr>
