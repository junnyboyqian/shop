...
<div class="tdare">
    <table width="100%" cellspacing="0" class="dataTable">
        ...
        <tr class="tatr1">
            ...
            <td align="left"><span ectype="order_by" fieldname="tag">品牌链接</span></td>
...
?>
        <tr class="tatr2">
            ...
            <td align="left"><span ectype="inline_edit" fieldname="brand_link" fieldid="<?php echo $this->_var['brand']['brand_id']; ?>" required="1" class="editable" title="可编辑"><?php echo $this->_var['brand']['brand_link']; ?><span></td>
